...
public class PdfViewActivitySecond extends AppCompatActivity {
    WebView webView;
    @Override
...
//        MywebViewClient2 mywebViewClient2=new MywebViewClient2();
    ...
    private class MywebViewClient1 extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String url) {
            ...
            if (isInternetConnected()) {
                ...
                Toast.makeText(PdfViewActivitySecond.this, "Sorry", Toast.LENGTH_SHORT).show();
            }
